CKEDITOR.editorConfig = function( config ) {
	...
	config.removeButtons = 'Save,Templates,NewPage,Preview,Print,Cut,Copy,Paste,PasteText,PasteFromWord,Scayt,Form,Checkbox,Radio,TextField,Textarea,Select,Button,ImageButton,HiddenField,CreateDiv,Language,Anchor,Flash,Iframe,BidiLtr,BidiRtl,Maximize,ShowBlocks,About,Undo,Redo,Replace,Find,SelectAll,CopyFormatting,RemoveFormat,Indent,Outdent,Link,Unlink';
